		...
		<div className="relative w-full min-h-[80vh] text-center text-gray-100 flex items-center">
			<div className="m-auto w-full backdrop-blur-sm ">
				<div className="relative m-auto max-w-fit w-[32rem] p-4  shadow-lg rounded-lg">
					...
					<div className="my-2">
						It may have moved or may no longer exist. If you reached
						this error from a link on our site, please leave us{" "}
						<Link to={"github.com"}> feedback</Link>, so we can fix
						the problem. Regardless, let's help you get where you
						want to go.
					</div>
