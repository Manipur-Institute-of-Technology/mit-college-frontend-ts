...
export default function Informations() {
  return (
    <>
      <div className="flex flex-wrap justify-around items-center w-full gap-4 m-2">
...
function Download() {
  return (
    <>
      <div className="flex flex-col gap-4 w-3xs p-4 border-2 border-gray-400 rounded-br-2xl rounded-tl-2xl">
        <div className="border-b-2 border-green-700 uppercase font-bold text-lg text-gray-700">
          Download
        </div>
        <div className="whitespace-nowrap flex flex-col gap-5 justify-items-start align-top">
