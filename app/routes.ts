  ...
  layout("./layouts/PublicContentLayout.tsx", [
    ...
    ...prefix("/faculty", [
      ...
      ...prefix(":facultyId", [
        ...
        layout("./layouts/FacultyLayout.tsx", [
          index("./routes/faculty/[facultyId]/about.tsx"),
          route("aboutme", "./routes/faculty/[facultyId]/about.tsx", {
            id: "facultyAbout1",
          }),
          route("teaching", "./routes/faculty/[facultyId]/teaching.tsx"),
          route("research", "./routes/faculty/[facultyId]/research.tsx"),
          route(
            "publications",
            "./routes/faculty/[facultyId]/publications.tsx",
          ),
          route("students", "./routes/faculty/[facultyId]/students.tsx"),
        ]),
      ]),
    ]),
  ]),
