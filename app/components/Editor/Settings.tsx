		...
		<>
			...
			{showSettings ? (
				<div className="switches">
					...
					<Switch
						onClick={() =>
							setOption("measureTypingPerf", !measureTypingPerf)
						}
					...
					<Switch
						onClick={() =>
							setOption("isCharLimitUtf8", !isCharLimitUtf8)
						}
					...
					<Switch
						onClick={() =>
							setOption("hasLinkAttributes", !hasLinkAttributes)
						}
					...
					<Switch
						onClick={() =>
							setOption("isAutocomplete", !isAutocomplete)
						}
