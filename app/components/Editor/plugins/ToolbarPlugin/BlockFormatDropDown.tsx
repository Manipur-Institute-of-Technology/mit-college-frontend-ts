...
export default function ToolbarPlugin({
	...
	const [toolbarViz, setToolbarViz] = useState<boolean>(editor.isEditable());

	editor.registerEditableListener((isEditable) => setToolbarViz(isEditable));
	...
	return (
		<>
			{toolbarViz ? (
				<div className="toolbar border border-gray-300 shadow-sm">
					<button
					...
					{toolbarState.blockType === "code" ? (
						<DropDown
							...
							buttonLabel={getLanguageFriendlyName(
						...
						<>
							...
							<Divider />
							<FontSize
								selectionFontSize={toolbarState.fontSize.slice(
									0,
									-2,
								)}
								editor={activeEditor}
